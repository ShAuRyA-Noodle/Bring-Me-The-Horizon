...
- Direct bumps: @excalidraw/excalidraw ^0.18.1, nitro ^3.0.260429-beta, vite ^7.3.2.
- `overrides`: @excalidraw/mermaid-to-excalidraw ^1.1.3, @tanstack/start-server-core ^1.167.30, @xmldom/xmldom ^0.9.10, dompurify ^3.4.0, h3 ^2.0.1-rc.18, mermaid ^10.9.6, nanoid ^3.3.8, postcss ^8.5.10.
